...
namespace SDRSharp.Tetra
{
    unsafe class MotherCode
    {
        ...
        private UnsafeBuffer _metric = UnsafeBuffer.Create((512 + RegisterLength) * RegisterStates, sizeof(float));
        private float* _metricPtr;
        private UnsafeBuffer _prev = UnsafeBuffer.Create((512 + RegisterLength) * RegisterStates, sizeof(int));
        ...
        {
            int destLength = (sourceLength / MotherCodeLength) - MotherCodeLength;
            ...
            fixed (sbyte* lutG0Ptr = _lutG0, lutG1Ptr = _lutG1, lutG2Ptr = _lutG2, lutG3Ptr = _lutG3)
            {
                ...
                for (int i = 0; i < destLength + MotherCodeLength; i++)
                {
            ...
            stateIndex = (destLength + MotherCodeLength) * RegisterStates;
            ...
            //Debug.Write(" " + zeroCounter.ToString() + " " + minSum.ToString());
