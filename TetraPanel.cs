  ...
  public class TetraPanel : UserControl
  {
    ...
    public unsafe TetraPanel(ISharpControl control)
    {
      try
      {
        ...
        if (this._tetraSettings.LogEntryRules == null || this._tetraSettings.LogEntryRules == string.Empty)
          this._tetraSettings.LogEntryRules = "date + time + mcc + mnc + la + cc + carrier + slot + callid + type + from + to + encryption + duplex";
        if (this._tetraSettings.LogFileNameRules == null || this._tetraSettings.LogFileNameRules == string.Empty)
          this._tetraSettings.LogFileNameRules = "date \\ frequency \\ mcc \"_\" mnc \"_\" la";
        if (this._tetraSettings.LogSeparator == null || this._tetraSettings.LogSeparator == string.Empty)
