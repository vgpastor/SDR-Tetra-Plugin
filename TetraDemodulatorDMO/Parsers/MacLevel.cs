    ...
    unsafe class MacLevel
    {
        ...
        public void SyncPDU(LogicChannel channelData, ReceivedData result)
        {
            ...
            switch (systemCode)
            {
                ...
                case 13:
                    ...
                    switch (pduType)
                    {
                        case 0:
                            ...
                            offset = GlobalFunction.ParseParams(channelData, offset, _dmacSyncInfoRulesDMO, result);
                            break;

                        case 1:
                            //DPRES-SYNC
                            //Debug.Write(" Dpres-Sync");
                            offset = GlobalFunction.ParseParams(channelData, offset, _dpresSyncInfoRules, result);
                            break;
                ...
                default:
                    GlobalFunction.ParseParams(channelData, offset, _syncInfoRulesTMO, result);
                    break;
            }
        ...
        public void SyncPDUHalfSlot(LogicChannel channelData, ReceivedData result)
        {
            ...
            if (result.TryGetValue(GlobalNames.SYNC_PDU_type, ref pduType))
            {
                ...
                {
                    case 0:
                        offset = GlobalFunction.ParseParams(channelData, offset, _dmacSyncInfoHalfSlotRules, result);
                    ...
                    case 1:
                        GlobalFunction.ParseParams(channelData, 0, _dpresSyncInfoHalfSlotRules, result);
                        break;
        ...
        {
            offset = GlobalFunction.ParseParams(channelData, offset, _dmacDataRules, result);
            var realLength = channelData.Length - offset;
        ...
        {
            offset = GlobalFunction.ParseParams(channelData, offset, _dmacEndRules, result);
