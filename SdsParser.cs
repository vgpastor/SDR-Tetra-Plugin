...
namespace SDRSharp.Tetra
{
  internal class SdsParser
  {
    ...
    {
      int length1 = 8;
      SdsProtocolIdent int32_1 = (SdsProtocolIdent) TetraUtils.BitsToInt32(channelData.Ptr, offset, length1);
      offset += length1;
      result.Add(GlobalNames.Protocol_identifier, (int) int32_1);
      if (int32_1 > SdsProtocolIdent.Reserved_127)
        offset = this.ParseTLService(channelData, offset, result);
      if (int32_1 <= SdsProtocolIdent.Simple_immediate_text)
      {
        if (int32_1 != SdsProtocolIdent.Simple_text_msg)
        {
          if (int32_1 != SdsProtocolIdent.Simple_location_system)
          {
            if (int32_1 != SdsProtocolIdent.Simple_immediate_text)
              goto label_17;
          }
        ...
        this.ParseTextMessage(channelData, offset, result);
        return;
      }
      if (int32_1 <= SdsProtocolIdent.Text_Messaging_TL)
      {
        if (int32_1 != SdsProtocolIdent.Location_information_protokol)
        {
          if (int32_1 != SdsProtocolIdent.Text_Messaging_TL)
            goto label_17;
        }
      ...
      else if (int32_1 != SdsProtocolIdent.Location_System_TL)
      {
        if (int32_1 != SdsProtocolIdent.Immediate_text_messaging_TL)
          goto label_17;
      }
      else
        goto label_13;
...
label_17:
    ...
    private unsafe void ParseTextMessage(LogicChannel channelData, int offset, ReceivedData result)
    {
      if (result.Contains(GlobalNames.OutOfBuffer))
        return;
      int num1 = result.Value(GlobalNames.Text_coding_scheme);
